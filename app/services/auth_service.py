...
class AuthService:
    ...
    def sign_up(self, email: str, password: str) -> tuple[bool, str]:
        ...
        try:
            ...
            err = r.json().get("msg") or r.json().get("error_description") or r.text
            return False, str(err)
        except Exception as e:
            self.offline_mode = True
            return False, f"لا يوجد اتصال — جرّب لاحقاً"
    ...
    def sign_in(self, email: str, password: str) -> tuple[bool, str]:
        ...
        try:
            ...
            err = r.json().get("error_description") or r.json().get("msg") or r.text
            return False, str(err)
        except Exception:
            self.offline_mode = True
