...
S: dict[str, dict[str, str]] = {
    "ar": {
        ...
        "activity_tip_home": "تطبيقاتي — تشغيل ما هو مثبّت",
        "activity_tip_store": "متجر التطبيقات — تنزيل وتحديث",
        "activity_tip_rank": "المتصدرون",
        "activity_tip_invite": "دعوة أصدقاء",
        "activity_tip_profile": "حسابي والإعدادات",
        "store_offline_hint": "ما ثبّته يعمل دون إنترنت. الشبكة للتنزيل والمزامنة فقط — لا تؤثر على تشغيل تطبيقاتك.",
        "store_search_ph": "ابحث في المتجر بالاسم أو الوصف…",
        "store_empty": "لا نتائج لهذا البحث — امسح البحث أو جرّب كلمات أخرى.",
        "status_syncing_registry": "مزامنة الكتالوج في الخلفية…",
        "status_catalog_online": "جاهز — الكتالوج محدّث · التطبيقات المثبّتة تعمل بدون اتصال",
        "status_catalog_local": "جاهز — وضع محلي · التطبيقات المثبّتة تعمل بدون اتصال",
        "update_section": "تحديث المنصّة",
        "update_check_btn": "التحقق من تحديث المنصّة",
        "update_open_release": "فتح صفحة الإصدار على GitHub",
        "update_addon_hint": "تحديثات التطبيقات: من «متجر التطبيقات» ثم زر «تحديث» على كل تطبيق.",
    ...
    "en": {
        ...
        "activity_tip_home": "My apps — run installed tools",
        "activity_tip_store": "App Store — install & update",
        "activity_tip_rank": "Leaderboard",
        "activity_tip_invite": "Invite friends",
        "activity_tip_profile": "Account & settings",
        "store_offline_hint": "Installed apps run offline. Network is for downloads and sync only — it does not block your apps.",
        "store_search_ph": "Search the store by name or description…",
        "store_empty": "No results — clear the search or try other words.",
        "status_syncing_registry": "Syncing catalog in the background…",
        "status_catalog_online": "Ready — catalog updated · Installed apps work offline",
        "status_catalog_local": "Ready — local catalog · Installed apps work offline",
        "update_section": "Platform update",
        "update_check_btn": "Check for platform update",
        "update_open_release": "Open release page on GitHub",
        "update_addon_hint": "App updates: App Store tab → Update on each app.",
