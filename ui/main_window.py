...
class MainWindow(QMainWindow):
    ...
    def _open_platform_update_from_store(self, registry_hint_ver: str = "") -> None:
        ...
        body = (
            ...
            "المنصّة **لا تنزّل ولا تثبّت** التحديث تلقائياً — يفتح هذا الزر صفحة الإصدارات فقط.\n"
            "نزّل **Setup.exe** أو **ZIP** من GitHub، أغلق علي جدّي بالكامل، ثم شغّل المثبّت.\n\n"
            "إن لم يظهر زر «تحديث»: قد يكون إصدارك يطابق السجل، أو فشلت المزامنة (تحقق من الإنترنت)، "
            "أو لم يُرفَع إصدار جديد بعد إلى السجل."
        )
