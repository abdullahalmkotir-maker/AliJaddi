# AliJaddi Beta 0.4.0 — Windows release: PyInstaller + ZIP مكمّل + مثبّت Inno (المعيار الرسمي، أسلوب Blender)
$ErrorActionPreference = "Stop"
$root = Split-Path -Parent $PSScriptRoot
Set-Location $root

Write-Host "=========================================="
Write-Host " AliJaddi - Windows Build (Beta 0.4.0, PySide6)"
Write-Host "=========================================="
...
$pyi = @(
    ...
    "--hidden-import", "ui.hosted_app_dock",
...
Write-Host (" PRIMARY (end users / Blender-style): {0}\windows\AliJaddi-Beta-0.4.0-Setup.exe" -f $tanzeel)
Write-Host (" Supplementary portable: {0}\windows\AliJaddi-Beta-0.4.0-Windows.zip" -f $tanzeel)
