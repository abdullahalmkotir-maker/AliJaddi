# Ali12 — تثبيت مدير الملفات Hassan12 بعد الموافقة
...
$msg = @"
Ali12 سيثبّت التطبيق في:
  $env:LOCALAPPDATA\Hassan12
...
[System.Windows.Forms.MessageBox]::Show(
    "اكتمل التثبيت. يمكنك تشغيل «مدير الملفات Hassan12» من اختصار سطح المكتب.",
    "Ali12",
    "OK",
    "Information"
)
